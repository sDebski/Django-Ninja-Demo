...
@router.get("devices/{slug}", response=DeviceSchema)
...
@router.post("devices", response={200: DeviceSchema, 404: Error})
...
@router.post("devices/{device_slug}/set-location", response=DeviceSchema)
